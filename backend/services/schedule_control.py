...
SOURCES: tuple[ScheduleSource, ...] = (
    ...
    ScheduleSource("live_positions", "Live Position Snapshot", "EXECUTION", "Every 15 minutes plus 5-minute market monitor", 18, "bot_state", ("snapshot_at", "created_at"), query={"_id": "live_position_snapshot_latest"}, critical=True, execution_scopes=("equity", "options"), repair="repull_alpaca_positions"),
    ScheduleSource("options_risk", "Options Risk Marks", "EXECUTION", "Every 5 minutes during market hours; QC watchdog off-hours", 18, "options_desk_risk_checks", ("checked_at", "created_at"), sort=("checked_at", -1), critical=True, execution_scopes=("options",), repair="recheck_options_positions"),
    ...
    ScheduleSource("kronos", "Kronos Forecast", "FORECAST", "09:30 ET forecast plus watchdog refresh", 180, "kronos_forecast_runs", ("generated_at", "created_at"), sort=("generated_at", -1), repair="refresh_kronos_snapshot"),
