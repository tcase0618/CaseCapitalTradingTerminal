...
SOURCES: tuple[ScheduleSource, ...] = (
    ...
    ScheduleSource("options_candidates", "Options Candidate Scan", "OPTIONS", "09:35 / 10:00 ET auto scan + execution preflight on market days", 390, "options_desk_candidates", ("generated_at", "created_at"), sort=("generated_at", -1), critical=True, execution_scopes=("options",), repair="refresh_options_candidates", market_session_only=True),
